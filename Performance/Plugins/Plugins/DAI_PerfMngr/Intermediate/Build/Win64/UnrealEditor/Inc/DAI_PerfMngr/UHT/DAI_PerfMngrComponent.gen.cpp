...
// Begin Class UDAI_PerfMngrComponent Function GetCurrentSignificance
struct Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentSignificance_Statics
{
	struct DAI_PerfMngrComponent_eventGetCurrentSignificance_Parms
	{
		float ReturnValue;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "PerfMngr" },
		{ "ModuleRelativePath", "Public/DAI_PerfMngrComponent.h" },
		{ "ToolTip", "Returns the last significance value computed for this actor (0..1, higher = more important)." },
	};
#endif // WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentSignificance_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DAI_PerfMngrComponent_eventGetCurrentSignificance_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentSignificance_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentSignificance_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentSignificance_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentSignificance_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDAI_PerfMngrComponent, nullptr, "GetCurrentSignificance", nullptr, nullptr, Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentSignificance_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentSignificance_Statics::PropPointers), sizeof(Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentSignificance_Statics::DAI_PerfMngrComponent_eventGetCurrentSignificance_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentSignificance_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentSignificance_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentSignificance_Statics::DAI_PerfMngrComponent_eventGetCurrentSignificance_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentSignificance()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentSignificance_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UDAI_PerfMngrComponent::execGetCurrentSignificance)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(float*)Z_Param__Result=P_THIS->GetCurrentSignificance();
	P_NATIVE_END;
}
// End Class UDAI_PerfMngrComponent Function GetCurrentSignificance
...
void UDAI_PerfMngrComponent::StaticRegisterNativesUDAI_PerfMngrComponent()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "GetCurrentSignificance", &UDAI_PerfMngrComponent::execGetCurrentSignificance },
...
struct Z_Construct_UClass_UDAI_PerfMngrComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UDAI_PerfMngrComponent_ForceSwapToFull, "ForceSwapToFull" }, // 3576021533
		{ &Z_Construct_UFunction_UDAI_PerfMngrComponent_ForceSwapToProxy, "ForceSwapToProxy" }, // 3709157120
		{ &Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentProxyState, "GetCurrentProxyState" }, // 4039741835
		{ &Z_Construct_UFunction_UDAI_PerfMngrComponent_GetCurrentSignificance, "GetCurrentSignificance" }, // 1770593072
		{ &Z_Construct_UFunction_UDAI_PerfMngrComponent_IsUsingProxy, "IsUsingProxy" }, // 2307067597
		{ &Z_Construct_UFunction_UDAI_PerfMngrComponent_SetPerformanceQuality, "SetPerformanceQuality" }, // 2451420363
		{ &Z_Construct_UFunction_UDAI_PerfMngrComponent_SwapToFull, "SwapToFull" }, // 639292177
		{ &Z_Construct_UFunction_UDAI_PerfMngrComponent_SwapToProxy, "SwapToProxy" }, // 3705668716
	};
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDAI_PerfMngrComponent_Statics::NewProp_ComponentSuppressionRules_Inner = { "ComponentSuppressionRules", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FComponentSuppressionRule, METADATA_PARAMS(0, nullptr) }; // 3823177320
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_githubdesktop_Wolfsige_plugins_Marketplace_UE5_5_DAI_PerfMngr_HostProject_Plugins_DAI_PerfMngr_Source_DAI_PerfMngr_Public_DAI_PerfMngrComponent_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EProxySwapState_StaticEnum, TEXT("EProxySwapState"), &Z_Registration_Info_UEnum_EProxySwapState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2994546515U) },
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FComponentSuppressionRule::StaticStruct, Z_Construct_UScriptStruct_FComponentSuppressionRule_Statics::NewStructOps, TEXT("ComponentSuppressionRule"), &Z_Registration_Info_UScriptStruct_ComponentSuppressionRule, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FComponentSuppressionRule), 3823177320U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDAI_PerfMngrComponent, UDAI_PerfMngrComponent::StaticClass, TEXT("UDAI_PerfMngrComponent"), &Z_Registration_Info_UClass_UDAI_PerfMngrComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDAI_PerfMngrComponent), 3038031406U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_githubdesktop_Wolfsige_plugins_Marketplace_UE5_5_DAI_PerfMngr_HostProject_Plugins_DAI_PerfMngr_Source_DAI_PerfMngr_Public_DAI_PerfMngrComponent_h_899509042(TEXT("/Script/DAI_PerfMngr"),
	Z_CompiledInDeferFile_FID_githubdesktop_Wolfsige_plugins_Marketplace_UE5_5_DAI_PerfMngr_HostProject_Plugins_DAI_PerfMngr_Source_DAI_PerfMngr_Public_DAI_PerfMngrComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_githubdesktop_Wolfsige_plugins_Marketplace_UE5_5_DAI_PerfMngr_HostProject_Plugins_DAI_PerfMngr_Source_DAI_PerfMngr_Public_DAI_PerfMngrComponent_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_githubdesktop_Wolfsige_plugins_Marketplace_UE5_5_DAI_PerfMngr_HostProject_Plugins_DAI_PerfMngr_Source_DAI_PerfMngr_Public_DAI_PerfMngrComponent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_githubdesktop_Wolfsige_plugins_Marketplace_UE5_5_DAI_PerfMngr_HostProject_Plugins_DAI_PerfMngr_Source_DAI_PerfMngr_Public_DAI_PerfMngrComponent_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_githubdesktop_Wolfsige_plugins_Marketplace_UE5_5_DAI_PerfMngr_HostProject_Plugins_DAI_PerfMngr_Source_DAI_PerfMngr_Public_DAI_PerfMngrComponent_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_githubdesktop_Wolfsige_plugins_Marketplace_UE5_5_DAI_PerfMngr_HostProject_Plugins_DAI_PerfMngr_Source_DAI_PerfMngr_Public_DAI_PerfMngrComponent_h_Statics::EnumInfo));
// End Registration
