...
public:
    ...
    /** Enable Mutable-based crowd support. */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "PerfMngr|Mutable", meta = (ToolTip = "Enable support for Mutable crowds."))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "PerfMngr|Mutable", meta = (ToolTip = "If true, shows on-screen debug info about which meshes and materials were combined."))
